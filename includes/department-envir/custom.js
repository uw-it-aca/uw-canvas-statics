...
(function () {
   ...
   *
   * @param {Event} event -- This may or may not have issues :) as escape is not used and exitFullScreen is possibly undefinted!!!
   */
...
(function () {
  ...
  summary.addEventListener('toggle', function () {
    ...
    if (summary.hasAttribute('open') && iframe.src.indexOf('h5p') !== -1) {
